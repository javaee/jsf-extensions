...
public class MainUI extends Application
    ...
    public void init() {
        ...
        loginButton = (UICommand) createComponent("javax.faces.Command",
                "javax.faces.Button");
    ...
    private void initLoginContent() {
        ...
        UIComponent formLayout = createComponent("javax.faces.Panel",
                "javax.faces.Grid");
        
        UIComponent field = createComponent("field");
        field.setId("user");
        field.getAttributes().put("label", "User:");
        UIComponent text = (UIComponent) createComponent("javax.faces.Input", 
                "javax.faces.Text");
        field.getFacets().put("input", text);
        formLayout.getChildren().add(field);
        
        field = createComponent("field");
        field.setId("pass");
        field.getAttributes().put("label", "Password:");
        text = (UIComponent) createComponent("javax.faces.Input", 
                "javax.faces.Secret");
        field.getFacets().put("input", text);
        formLayout.getChildren().add(field);
