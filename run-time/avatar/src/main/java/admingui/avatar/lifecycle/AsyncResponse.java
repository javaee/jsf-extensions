package admingui.avatar.lifecycle;

import admingui.avatar.application.DeferredStateManager;
import admingui.avatar.components.PartialTraversalViewRoot;
...
public class AsyncResponse {
    ...
    public static final String FACES_EVENT_CONTEXT_PARAM = "admingui.avatar.FacesEvents";
