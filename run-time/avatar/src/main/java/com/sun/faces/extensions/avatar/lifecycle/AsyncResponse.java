...
public class AsyncResponse {
    ...
    public EncoderHandler getEncodeHandlerInstance() {
        if (null == encoderHandler) {
            encoderHandler = new DefaultEncoderHandler();
        }
        return encoderHandler;
    }
    
    public void setEncoderHandlerInstance(EncoderHandler handler) {
    ...
    static public boolean isSkipUpdate() {
        FacesContext context = FacesContext.getCurrentInstance();
        return null != context.getExternalContext().
                getRequestHeaderMap().get(SKIP_UPDATE_HEADER);
    }
    ...
    public static final String SKIP_UPDATE_HEADER = FACES_PREFIX + "SkipUpdate";
