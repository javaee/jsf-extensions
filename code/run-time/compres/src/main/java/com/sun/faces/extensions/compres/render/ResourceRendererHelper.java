 ...
 * @author edburns
 */
public class ResourceRendererHelper {
    
    /** Creates a new instance of ResourceRendererHelper */
    private ResourceRendererHelper() {
    }
    
    static Resource getResource(FacesContext facesContext, UIComponent comp) {
